...
import { ActivityIndicator, StyleSheet, View, SafeAreaView, Dimensions, BackHandler } from "react-native"
...
export default class MyCompetitionDetail extends React.Component {
    constructor(props) {
        super(props)
    ...
    handleBackButton = () => {
        if (this.WEBVIEW_REF.current) {
            if (this.state.canGoBack) {
                this.WEBVIEW_REF.current.navigate({ name: Home })
    ...
    render() {
        ...
        return (
            <SafeAreaView style={styles.mainContainer}>
                <Header navigation={this.props.navigation} type={this.state.type} webview={this.WEBVIEW_REF.current} webviewBackStatus={this.state.canGoBack} />
                ...
                {this.state.isNetworkAvailable ? (
                    <View style={{ flex: 1 }}>
                        ...
                        <WebView
                            ...
                            style={{ flex: 1 }}
                            // source={{ uri: `https://${strings.getLanguage()}.hjcbt.org/bbs/board.php?bo_table=ceremony` }}
                            ...
                            // injectedJavaScriptBeforeContentLoaded={this.autoLogininWebPage()}
                        />
                    </View>
                ) : null}
            </SafeAreaView>
